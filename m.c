...
A an(U n,C t)_(Q(!lck);Q(LH(tA,t,tn-1));Q(!TP(t));C b=59-__builtin_clzll(HD|HD-1+((W)n*TW[t]>>3));P(n>1ull<<L(z)||b>L(z)-2,die("OOM"))
...
A aV(C t,U n,O V*v)_(A x=an(n,t);MC(xV,v,(W)n*TW[t]>>3);x)
