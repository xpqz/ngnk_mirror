...
S A1(par,apc(pre('(',x),')'))
S A1(ek,e1f(kst,x))
S A1(kss,S C e[128]={'0',[9]='t','n',[13]='r',[34]='"',[92]='\\'};U n=xn+2;i(xn,C c=xc;P(c>126u||(c<32&&!e[c]),cat11(aCz("0x"),hex(x)))n+=!!e[c])
...
X1(kst,R_(aCz("???"))
 ...
 RC(     xn==1?kT1(x):kss(x))
 RBGHILF(xn==1?kT1(x):xn?jc(32,e1f(str,x)):x(aCz(xtF?"0#0n":"!0")))
