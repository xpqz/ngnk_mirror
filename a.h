...
A3 _2,aA3,arf,arp,ars,cpl,r2,try;A4 ara,a4,d4;AX _8,adv,e8,f8,prj,run;AA a8,d8,ins,no8;AL aA,aB,aC,aD,aI,aL,aS,al,az,cls,rndD,tilL;ALA drp,room,rsz;AAL ii;AQ aCz,bsl,bsm,die,evs,pk,sym;
