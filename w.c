...
S I arf2(A2 f)_((SZ(V*)-8?fI:fL)(v2+1,10,(L)f)!=NL)S A o1f(A1 f,Ax/*f1*/)_(f==len?x(ai(0)):f==str?x(oC):x)S A o2f(A2 f,Ax,Ay/*f01*/)_(f==bng?y(ai(0)):arf2(f)?f(x,y):y(oC))
...
A e1f(A1 f,Ax)_(Xt(f(x))Xm(Ay=kv(&x);am(x,Nx(e1f(f,y))))Nn=xN;P(!n,rs0(enl(N(o1f(f,fir(x))))))
 I b=xtA&&xr==1;Ay=aA0(n);i(n,Az=f(b?xa:ii(x,i));B(!z,I(b,mrn(xn-i-1,xA+i+1))y=y(0))yq(z))I(b,x=AZ(x))x(y))
S A2(e1,/*01*/Xu(e1f(v1[xv],y))Yt(x1(y))Ym(em(x,&y,1))Nm=yN;P(!m,rs0(enl(N(o1(x,fir(y))))))P(ytA&&yr==1,y=AZ(y);Au=oA;i(m,Az=x1(ya);B(!z,u=u(0);mrn(m-i-1,yA+i+1))uq(z))y(u))
                                                                                                                Au=oA;i(m,Az=x1(ii(y,i));B(!z,u=u(0))             uq(z))y(u))
  A l2f(A2 f,Ax,Ay/*f01*/)_(Xt(f(x,y))Xm(Az=N(l2f(f,xy,y));       am(_R(xx),z) )Nn=xN;P(!n,          rs0(enl(N(o2f(f,x,fir(y))))))Au=aA0(n);i(n,A w=ii(x,i),v=f(w,yR);mr(w); B(!v,u=u(0))uq(v))y(u))
S A r2f(A2 f,Ax,Ay/*f01*/)_(Yt(f(x,y))Ym(Az=Ny(r2f(f,x,_R(yx)));y(am(_R(yx),z)))Nn=yN;P(!n,x=fir(xR);rs0(enl(N(x(o2f(f,x,y))))))  Au=aA0(n);i(n,A v=f(x,ii(y,i));            B(!v,u=u(0))uq(v))y(u))
S A3(l2,/*001*/Xv(l2f(v2[xv],y,z))Yt(x2(y,z))Ym(x=prj(x,A(PLH,z),2);x(e1(x,yR)))Nn=yN;P(!n,y=fir(yR);rs0(enl(N(y(o2(x,y,z))))))   Au=aA0(n);i(n,A w=ii(y,i),v=x2(w,zR);mr(w);B(!v,u=u(0))uq(v))z(u))
  A3(r2,/*001*/Xv(r2f(v2[xv],y,z))Zt(x2(y,z))Zm(x=prj(x,A(yR,PLH),2);x(e1(x,z)))Nn=zN;P(!n,          rs0(enl(N(o2(x,y,fir(z)))))) Au=aA0(n);i(n,A v=x2(y,ii(z,i));           B(!v,u=u(0))uq(v))z(u))
...
A e2f(A2 f,Ax,Ay/*f01*/)_(Ik=2*xtt+ytt;P(k==3,f(x,y))
 ...
 P(!k&&xN-yN,el1(y))Nn=k<2?xN:yN;P(!n,x=fir(xR);rs0(enl(N(x(o2f(f,x,fir(y)))))))Az=oA;i(n,A v=ii(x,i);Au=f(v,ii(y,i));mr(v);B(!u,z=z(0))zq(u))y(z))
