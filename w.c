...
SN A2(bin,/*01*/Xm(_1(xx,bin(xy,y)))Q(xtZC)Yzc(I w=xw;Li=-1,j=xn,q=gl(y);W(i+1<j,Lm=(i+j)/2;q<iw(x,w,m)?j=m:(i=m))az(i))
...
S A emp2f(Ax,Ay,A2 f/*00f*/)_(f==mod?oB:oA)              S A3(emp2,/*000*/ztv?emp2f(x,y,v2[zv]):oA)
