...
S A stn(Ax,Ln,Ay/*0n0*/)_(P(n<0||n-(I)n,ed0())P(!ytT,et0())Lm=max(0,yn-n+1);Az=AN(0,aA(m));i(m,zq(Nz(x1(slc(y,i,i+n)))))z)S A3(ste,/*010*/Yz(stn(x,gl(y),z))et1(y))S ALA(win,x(stn(au,n,x)))
S A2 binF;
S A2(binZ,/*01*/Q(xtZC)
