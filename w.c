...
SN A2(enc,/*01*/P(!xtzZ,en1(y))P(x==ai(2)&&ytz&&gl_(y)<0,x=rln(64,xR);x(enc(x,y)))
...
SN A1(raz,XA(Nn=0;i(xn,n+=_N(xa))Ay=xx;y=AN(0,an(!xn?tC:ytT?yt:tA,n));i(xn,y=cat11(y,_R(xa)))x(y))Xm(raz(val(x)))x)
