...
A e1f(A1 f,Ax)_(Xt(f(x))Xm(Ay=kv(&x);am(x,Nx(e1f(f,y))))I b=xtA&&xr==1;Nn=xN;P(!n,o1f(f,x))Ay=aA0(n);i(n,Az=f(b?xa:ii(x,i));B(!z,I(b,mrn(xn-i-1,xA+i+1))y=y(0))yq(z))I(b,x=AN(0,x))x(y))
...
A l2f(A2 f,Ax,Ay/*f01*/)_(          Xt(f(x,y))Xm(Az=N(l2f(f,xy,y));am(_R(xx),z))Nn=xN;P(!n,o2f(f,x,y))Au=aA0(n);i(n,A w=ii(x,i),v=f(w,yR);mr(w);B(!v,u=u(0))uq(v))y(u))
S A r2f(A2 f,Ax,Ay/*f01*/)_(Yt(f(x,y))Ym(Az=Ny(r2f(f,x,_R(yx)));y(am(_R(yx),z)))Nn=yN;P(!n,o2f(f,x,y))Au=aA0(n);i(n,A v=f(x,ii(y,i));B(!v,u=u(0))uq(v))y(u))
S A3(l2,/*001*/Xv(l2f(v2[xv],y,z))Yt(x2(y,z))Ym(x=prj(x,A(PLH,z),2);x(e1(x,yR)))Nn=yN;P(!n,o2(x,y,z))Au=aA0(n);i(n,A w=ii(y,i),v=x2(w,zR);mr(w);B(!v,u=u(0))uq(v))z(u))
  A3(r2,/*001*/Xv(r2f(v2[xv],y,z))Zt(x2(y,z))Zm(x=prj(x,A(yR,PLH),2);x(e1(x,z)))Nn=zN;P(!n,o2(x,y,z))Au=aA0(n);i(n,A v=x2(y,ii(z,i));B(!v,u=u(0))uq(v))z(u))
...
S A3(s2,/*010*/Zt(y(x2(y,zR)))Zm(am(_R(zx),s2(x,y,zy)))P(!zN,y(zR))P(xtv&&xv<11&&ytzc&&ztZC,ars(x,y,z))Au=aA0(zN);i(zN,y=y(x2(y,ii(z,i)));P(!y,u(0))uq(yR))y(u))
...
S A stn(Ax,Ln,Ay/*0n0*/)_(P(n<0||n-(I)n,ed0())P(!ytT,et0())Lm=max(0,yn-n+1);Az=aA0(m);i(m,zq(Nz(x1(slc(y,i,i+n)))))z)S A3(ste,/*010*/Yz(stn(x,gl(y),z))et1(y))S ALA(win,x(stn(au,n,x)))
S A2 binF;
S A2(binZ,/*01*/Q(xtZC)
