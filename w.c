...
S AX(l8,/*01..1*/Ab8;MC(b,a,8*n);*b=GAP;x=prj(x,b,n);x(e1(x,*a)))
  A3(e2,/*001*/Xv(e2f(v2[xv],y,z))Yt(r2(x,y,z))Zt(l2(x,y,z))P(ytm||ztm,em(x,A(yR,z),2))N m=yN;P(m-zN,el1(z))P(!m,z(xtv&&xv<11?yR:oA))A u=0;C t=ztA&&zr==1;
...
A e2f(A2 f,A x,A y/*f01*/)_(I k=xtt<<1|ytt;P(k==3,f(x,y))
 ...
 P(!k&&xN-yN,el1(y))N n=k<2?xN:yN;P(!n,x=fir(xR);x(o2f(f,x,fir(y))))A z=oA;i(n,A v=ii(x,i);A u=f(v,ii(y,i));mr(v);B(!u,z=z(0))zq(u))y(z))
...
S A3(ls2,/*010*/Y(Ril(ns(x,gl(y),zR))RU(y(ws(x,y,zR)))R_(et1(y)))0)
S A3(lf2,/*010*/Y(Ril(nf(x,gl(y),zR))RU(y(wf(x,y,zR)))R_(et1(y)))0)
...
S A3(p2,/*010*/Zt(er1(y))Zm(y=N(p2(x,y,zy));am(_R(zx),y))P(!zN,y(zR))P(xtv&&xv<11&&ytzc&&ztZC,arp(x,y,z))A u=aA0(zN);i(zN,A v=ii(z,i),r=x2(v,y);y=v;B(!r,u=u(0))uq(r))y(u))
