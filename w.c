...
A l2f(A2 f,Ax,Ay/*f01*/)_(Xt(f(x,y))Xm(Az=N(l2f(f,xy,y));am(_R(xx),z))Nn=xN;P(!n,o2f(f,x,y))Au=oA;i(xN,A w=ii(x,i),v=f(w,yR);mr(w);B(!v,u=u(0))uq(v))y(u))
SN A r2f(A2 f,Ax,Ay/*f01*/)_(Yt(f(x,y))Ym(Az=Ny(r2f(f,x,_R(yx)));y(am(_R(yx),z)))Nn=yN;P(!n,o2f(f,x,y))Au=oA;i(yN,A v=f(x,ii(y,i));B(!v,u=u(0))uq(v))y(u))
SN A3(l2,/*001*/Xv(l2f(v2[xv],y,z))Yt(y(x2(y,z)))Ym(x=prj(x,A(PLH,z),2);x(e1(x,yR)))Nn=yN;P(!n,o2(x,y,z))Au=oA;i(yN,A w=ii(y,i),v=x2(w,zR);mr(w);B(!v,u=u(0))uq(v))z(u))
NI A3(r2,/*001*/ Xv(r2f(v2[xv],y,z))Zt(y(x2(y,z)))Zm(x=prj(x,A(yR,PLH),2);x(e1(x,z)))Nn=zN;P(!n,o2(x,y,z))Au=oA;i(zN,A v=x2(y,ii(z,i));B(!v,u=u(0))uq(v))z(u))
