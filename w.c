...
SN AX(s8,P(n==1,s1(x,*a))P(n==2,Ay=*a;y(s2(x,y,a[1])))Ay=*a++;n--;Lm=cfm(a,n);P(m==-2,y(el8(a,n)))Az=AN(0,aA(m));Ab8;i(m,*b=y;j(n,b[j+1]=ii(a[j],i))y=x8(b,n+1);P(!y,mrn(n,a);z(0))zq(yR))mrn(n,a);y(z))
