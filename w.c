...
S A3(l2,/*001*/Xv(l2f(v2[xv],y,z))Yt(x2(y,z))Ym(x=prj(x,A(PLH,z),2);x(e1(x,yR)))Nn=yN;P(!n,o2(x,y,z))Au=AN(0,aA(n));i(n,A w=ii(y,i),v=x2(w,zR);mr(w);B(!v,u=u(0))uq(v))z(u))
  A3(r2,/*001*/Xv(r2f(v2[xv],y,z))Zt(x2(y,z))Zm(x=prj(x,A(yR,PLH),2);x(e1(x,z)))Nn=zN;P(!n,o2(x,y,z))Au=AN(0,aA(n));i(n,A v=x2(y,ii(z,i));B(!v,u=u(0))uq(v))z(u))
...
S A3(s2,/*010*/Zt(y(x2(y,zR)))Zm(am(_R(zx),s2(x,y,zy)))P(!zN,y(zR))P(xtv&&xv<11&&ytzc&&ztZC,ars(x,y,z))Au=AN(0,aA(zN));i(zN,y=y(x2(y,ii(z,i)));P(!y,u(0))uq(yR))y(u))
...
A3(w2,/*010*/Q(xtr)Ii=xE;x=xx;SW(i,
 CR(0,y(e2(x,y,zR)))CR(1,P(xK<2,lf2(x,y,z))f2(x,y,z))CR(2,P(xK<2,ls2(x,y,z))s2(x,y,z))CR(3,xK==1?y(ste(x,y,zR)):p2(x,y,z))CR(4,y(r2(x,y,zR)))CR(5,y(l2(x,y,zR))))en1(y))
AX(w8,/*01..1*/Q(xtr)Ay=*a;P(n==1,w1(x,y))P(n==2,Az=a[1];z(w2(x,y,z)))Ii=xE;x=xx;SW(i,
