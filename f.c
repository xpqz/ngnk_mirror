...
X2(fnd,
 ...
 R5(tH,tI,tL,tF,tS,
  ...
  YE(fnd(x,gZ(y)))
  P(xt==TT[yt]||xtZ&&ytzZ,
   TY(fGL)*f=G(&fGL,fHL,fIL,fLL)[xw];V*a=xV;U m=xn;
   Yt(az(f(a,m,gl(y))))
   U n=yn;A z=aL(n);My(S4(yw,i(n,zl=f(a,m,yg)),i(n,zl=f(a,m,yh)),i(n,zl=f(a,m,yi)),i(n,zl=f(a,m,yl))))z)
  fN(y)))
