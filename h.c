...
A2(cat11,
 P(xtT&&ytT,P(!yn,y(x))P(!xn,x(y))I(xtZ&&ytzZ,N(sup(&x,&y)))I(xt-yt,x=cA(x);y=cA(y))Nm=xn,n=yn,w=xW;x=room(m+n,x);Mc(xV+m*w,yV,n*w);I(ytA,yr-1?mRa(y):AZ(y))y(x))
 P(xtm&&ytm,y(a4(x,yx,av,yy)))
 Xmt(cat11(enl(x),y))
 Ymt(apd(x,y))
