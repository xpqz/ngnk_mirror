...
S A1(qa,A y=oA;Q*p=argv;W(*p,PSH(y,aCz(*p++)))y(y1(x)))
S A1(qe,A y=oS,z=oA;Q*e=env;W(*e,Q p=*e++,q=strchrnul(p,'=');PSH(y,cS(aCm(p,q)));PSH(z,aCz(q+!!*q)))y=am(y,z);x-au?x(x1(y)):y)
