...
#define i_(f,T,R,e...) S L f(V*RES a,Nm,OV*RES b,V*RES c,Nn)_(T*p=a;O I*q=b;R*r=c;LI(p)LI(q)LI(r)e;n)
i_(iG,G,G,UI g=32;I k[g];i(n/g,j(g,k[j]=q[j])I o=0;j(g,o|=!IN(k[j],m))P(o,i*g)j(g,r[j]=p[k[j]])q+=g;r+=g)L l=n/g*g;j(n-l,P(!IN(q[j],m),l))j(n-l,r[j]=p[q[j]]))
i_(iH,H,H,UI g=16;I k[g];i(n/g,j(g,k[j]=q[j])I o=0;j(g,o|=!IN(k[j],m))P(o,i*g)j(g,r[j]=p[k[j]])q+=g;r+=g)L l=n/g*g;j(n-l,P(!IN(q[j],m),l))j(n-l,r[j]=p[q[j]]))
i_(iI,I,I,UI g= 8;I k[g];i(n/g,j(g,k[j]=q[j])I o=0;j(g,o|=!IN(k[j],m))P(o,i*g)j(g,r[j]=p[k[j]])q+=g;r+=g)L l=n/g*g;j(n-l,P(!IN(q[j],m),l))j(n-l,r[j]=p[q[j]]))
S L iC(V*RES a,Nm,OV*RES b,V*RES c,Nn)_(C*p=a;O I*q=b;C*r=c;LI(p)LI(q)LI(r)i(n,r[i]=IN(q[i],m)?p[q[i]]:32)n)
S L iF(V*RES a,Nm,OV*RES b,V*RES c,Nn)_(F*p=a;O I*q=b;F*r=c;LI(p)LI(q)LI(r)i(n,r[i]=IN(q[i],m)?p[q[i]]:NF)n)
S L iS(V*RES a,Nm,OV*RES b,V*RES c,Nn)_(I*p=a;O I*q=b;I*r=c;LI(p)LI(q)LI(r)i(n,r[i]=IN(q[i],m)?p[q[i]]: 0)n)
S L jG(V*RES a,Nm,OV*RES b,V*RES c,Nn)_(G*p=a;O I*q=b;L*r=c;LI(p)LI(q)LI(r)i(n,r[i]=IN(q[i],m)?p[q[i]]:NL)n)
S L jH(V*RES a,Nm,OV*RES b,V*RES c,Nn)_(H*p=a;O I*q=b;L*r=c;LI(p)LI(q)LI(r)i(n,r[i]=IN(q[i],m)?p[q[i]]:NL)n)
S L jI(V*RES a,Nm,OV*RES b,V*RES c,Nn)_(I*p=a;O I*q=b;L*r=c;LI(p)LI(q)LI(r)i(n,r[i]=IN(q[i],m)?p[q[i]]:NL)n)
S L jL(V*RES a,Nm,OV*RES b,V*RES c,Nn)_(L*p=a;O I*q=b;L*r=c;LI(p)LI(q)LI(r)i(n,r[i]=IN(q[i],m)?p[q[i]]:NL)n)
A2(i1,/*01*/P(y==PLH||y==au,xR)
 ...
 Y(Rzc(io(x,gl(y)))RmM(Az=kv(&y);am(y,Ny(i1(x,z))))RA(r2(AP1,x,y))RE(Li=*yL,j=yL[1];P(0<=i&&i<j&&j<xN,y(0);slc(x,i,j))i1(x,gZ(y)))R3(tG,tH,tC,i1(x,cI(y)))R_(et1(y))
  ...
  RI(Nn=yn;XA(Az=aA(n);i(n|!n,za=io(x,yi))y(0);I(!zn,zx=mkn(zx))sqz(z))
   Az=an(n,xt);Lm=G(&iG,iH,iI,jL,iF,iC,iS)[xt-tG](xV,xn,yV,zV,n);
   I(m<n,z=z(aL(n));G(&jG,jH,jI)[xt-tG](xV,xn,yV,zV,n))
   y-z?y(z):z))0)
