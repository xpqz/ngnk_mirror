...
A2(i1,/*01*/P(y==PLH||y==au,xR)
 ...
 Y(Rzc(io(x,gl(y)))RmM(Az=kv(&y);am(y,Ny(i1(x,z))))RA(r2(AP1,x,y))RE(Li=*yL,j=yL[1];P(0<=i&&i<j&&j<xN,y(0);slc(x,i,j))i1(x,gZ(y)))R3(tG,tH,tC,i1(x,cI(y)))R_(et1(y))
  ...
  RI(Nn=yn;XA(Az=aA(n);i(n|!n,za=io(x,yi))y(0);I(!zn,zx=mkn(zx))sqz(z))
   Az=an(n,xt);Lm=A(&iG,iH,iI,jL,iF,iC,iS)[xt-tG](xV,xn,yV,zV,n);
   I(m<n,z=z(aL(n));A(&jG,jH,jI)[xt-tG](xV,xn,yV,zV,n))
   y-z?y(z):z))0)
...
A2(_1,/*01*/P(!xtt,i1(x,y))Ik=xK;P(1<k,k==2&&!xtp?prj(x,A(y,PLH),2):prj(x,&y,1))
 X(Ro(run(x,&y,1))Rr(w1(xE,xx,y))Rx(((A1*)(x<<16>>16))(y))Rq(_1(xx,N(_1(xy,y))))Ru(v1[xv](y))Rw(AK(0<xv&&xv<4&&yK==2?1:ytU?yK:1,AW(xv,aV(tr,1,&y))))R_(et1(y))
  ...
  Rs(S O C s[][4]={"","k","j","p","t","x","hex","err","argv","env","exit","js","pri","prng","sin","cos","exp","ln"};
   Li=fI(s,L(s),xv);A(&ser,kst,js1,qp,qt,frk,hex,err,qa,qe,qx,qjs,qpri,prng,ksin,kcos,kexp,klog,ed1)[i<0?L(s):i](y)))0)
