...
SN U maxfU(CO U*a,U n)_(U v=0;i(n,v=MAX(v,a[i]))v)
#define ambcn CO V*RES a,U m,CO U*RES b,V*RES c,U n
SN V iG(ambcn){CO G*p=a;G*r=c;i(n,*r++=p[*b++])}
SN V iH(ambcn){CO H*p=a;H*r=c;i(n,*r++=p[*b++])}
SN V iI(ambcn){CO I*p=a;I*r=c;i(n,*r++=p[*b++])}
SN V iC(ambcn){CO C*p=a;C*r=c;i(n+31&-32,*r++=b[i]<m?p[b[i]]:32)}
SN V iS(ambcn){CO I*p=a;I*r=c;i(n+7&-8,*r++=b[i]<m?p[b[i]]: 0)}
SN V oG(ambcn){CO G*p=a;L*r=c;i(n+3&-4,*r++=b[i]<m?p[b[i]]:NL)}
SN V oH(ambcn){CO H*p=a;L*r=c;i(n+3&-4,*r++=b[i]<m?p[b[i]]:NL)}
SN V oI(ambcn){CO I*p=a;L*r=c;i(n+3&-4,*r++=b[i]<m?p[b[i]]:NL)}
SN V o8(ambcn,L v){CO L*p=a;L*r=c;i(n+3&-4,*r++=b[i]<m?p[b[i]]:v)}
