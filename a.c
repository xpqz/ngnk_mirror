...
A mnd(OA*a,In,AA*f)_(Ax=*a;Q(xtsS)I(xtS,x=K("`$\".\"/$:",x))Li=fI(gk,gn,xv);I(i<0,gk[i=gn++]=xv)A*p=gv+i;I(!*p,*p=au)
 P(!p,mrn(n-1,a+1);0)Ab8;*b=*p;Mc(b+1,a+1,(n-1)*8);*p=au;*p=_R(N(f(b,n))))
