...
AA(d8,/*10..0*/Ax=*a;XsS(Lk=gkk(x);Li=fL(gk,gn,k);I(i<0,gk[i=gn++]=k)A*p=gv+i;I(!*p,*p=au)Ab8;*b=*p;MC(b+1,a+1,n-1<<3);*p=au;*p=_R(N(d8_(b,n))))I(n==3,XU(try(x,a[1],a[2])))d8_(a,n))
