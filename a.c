...
A2(_1,/*01*/P(!xtt,i1(x,y))U k=xK;P(1<k,k==2&&!xtp?prj(x,A(y,GAP),2):prj(x,&y,1))
 X(Ro(run(x,&y,1))Rr(w1(xE,xx,y))Rx(((A1*)(x<<16>>16))(y))Rq(_1(xx,N(_1(xy,y))))Ru(v1[xv](y))Rw(AK(0<xv&&xv<4&&yK==2?1:ytU?yK:1,AW(xv,aV(tr,1,&y))))R_(et(y))
...
A3(_2,/*001*/P(!xtt,i2(x,y,z))A a[]={y,z};U k=xK;P(2<k,yR;prj(x,a,2))
 X(Rv(v2[xv](y,z))Ro(yR;run(x,a,2))Rr(z(w2(xE,xx,yR,z)))Rw(xv?en(x):AK(zK,AT(tq,aA2(yR,z))))Rq(_1(xx,N(_2(xy,y,z))))Rx(P(2>k,er(z))((A2*)(x<<16>>16))(yR,z))R_(et(z))
...
AX(_8,/*01..1*/Q(n)P(n==1,x1(*a))P(n==2&&!xtp,A y=*a;y(x2(y,a[1])))P(!xtt,i8(x,a,n))U k=xK;P(n<xK,prj(x,a,n))
 X(Ro(run(x,a,n))Rv(x=v8[xv](a,n);mrn(n-1,a+1);x)Rr(w8(xE,xx,a,n))Rq(_1(xx,N(_8(xy,a,n))))R_(et8(a,n))
  Rp(P(xn+xK>9,er8(a,n))I m=xn-1,j=0;Ab8;i(m,b[i]=xA[i+1]==GAP&&j<n?a[j++]:_R(xA[i+1]))I l=MAX(0,n-j);MC(b+m,a+j,8*l);_8(xx,b,m+l))
  Rx(P(n>k,er8(a,n))V*f=(V*)(x<<16>>16);SW(k,R(3,((A3*)f)(a[0],a[1],a[2]))R(4,((A4*)f)(a[0],a[1],a[2],a[3]))R_(en8(a,n)))0))0)
