...
A3(_2,/*011*/P(!xtt,i2(x,y,z))A a[]={y,z};Ik=xK;P(2<k,prj(x,a,2))Xo(run(x,a,2))Xv(v2[xv](y,z))Xr(adv(x,a,2))
 ...
 Xq(_1(xx,N(_2(xy,y,z))))P(2>k,er2(y,z))Xw(AK(0<xv&&xv<4&&yK==2?1:ytF?yK:1,AW(xv,aV(tr,1,a))))Xe(en2(y,z))et2(y,z))
...
AA(am8,Ax=*a,y=a[1];
 ...
 et8(a,n))
S A3(am3,am8(A(x,y,z  ),3))
S A4(am4,am8(A(x,y,z,u),4))
A3(dm3,Nm=yN;P(y==au||!m,z(z1(y(x)  )))P(m==1,am3(x,fir(y),z  ))yR;am8(A(x,fir(y),prj(DOT,A(PLH,drp(1,y)),2),z  ),4))
A4(dm4,Nm=yN;P(y==au||!m,z(z2(y(x),u)))P(m==1,am4(x,fir(y),z,u))yR;am8(A(x,fir(y),prj(DOT,A(PLH,drp(1,y)),2),z,u),5))
