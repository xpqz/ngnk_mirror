...
S A3(mmmf,/*010*/Ii=xv==7;P((y&&ytd)||ztD,Lv=ofpd1(y?gd(cD(y)):i?-WD:WD);z=cD(zR);ad(ze(OFP1(z);L r=mmmfZ(v,z,i);OFP0(z);ofpd0(r))))Lv=y?gl(y):i?-WL:WL;az(mmmfZ(v,z,i)))
S A3(admf,/*010*/Ii=xv==3;Nn=zn;P((y&&ytd)||ztD,Dv=y?gd(cD(y)):i;z=cD(zR);ad(ze(I(i,i(n,v*=zd))E(i(n,v+=zd))v)))Lv=y?gl(y):i;I(i,i4(zw,n,v*=zb,v*=zh,v*=zi,v*=zl))E(i4(zw,n,v+=zb,v+=zh,v+=zi,v+=zl))az(v))
S A3(subf,/*010*/y=y?neg(y):zn?mul(ai(-2),ii(z,0)):ai(0);neg(admf(ADD,y,z)))
A3(arf,/*010*/Q(xtv)Q(xv<11)Q(!y||ytzdc)Q(ztZDC)T(&dexf,admf,subf,admf,___f,___f,mmmf,mmmf,___f,___f,___f)[xv](x,y,z))
