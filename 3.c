...
G minfG(O G*a,U n)_(G r=(1u  << 7)-1;i(n,MINE(r,a[i]))r)
H minfH(O H*a,U n)_(H r=(1u  <<15)-1;i(n,MINE(r,a[i]))r)
I minfI(O I*a,U n)_(I r=(1u  <<31)-1;i(n,MINE(r,a[i]))r)
L minfL(O L*a,U n)_(L r=(1ull<<63)-1;i(n,MINE(r,a[i]))r)
G maxfG(O G*a,U n)_(G r=(1u  << 7)  ;i(n,MAXE(r,a[i]))r)
H maxfH(O H*a,U n)_(H r=(1u  <<15)  ;i(n,MAXE(r,a[i]))r)
I maxfI(O I*a,U n)_(I r=(1u  <<31)  ;i(n,MAXE(r,a[i]))r)
L maxfL(O L*a,U n)_(L r=(1ull<<63)  ;i(n,MAXE(r,a[i]))r)
L minfZ(L v,A x/*0*/)_(U w=xw;O V*a=xV;U n=xn;MIN(v,!w?minfG(a,n):w==1?minfH(a,n):w==2?minfI(a,n):minfL(a,n)))
L maxfZ(L v,A x/*0*/)_(U w=xw;O V*a=xV;U n=xn;MAX(v,!w?maxfG(a,n):w==1?maxfH(a,n):w==2?maxfI(a,n):maxfL(a,n)))
S A3(mmmf,/*010*/I i=xv==7;P((y&&ytf)||ztF,y=of1(y?cF(y):aV(tf,1,A((L)i<<63|WFL)));z=of1(cF(zR));of0(N(z(mmmf(x,y,z)))))L v=y?gl(y):i?-WL:WL;
 L l=-1ll<<8*zW-1,h=~l;U n=zn;P((i?v>=h:v<=l)||!n,az(v))v=v<l?l:v>h?h:v;az(i?maxfZ(v,z):minfZ(v,z)))
L addfZ(L v,A x/*0*/)_(i4(xw,xn,v+=xg,v+=xh,v+=xi,v+=xl)v)
L mulfZ(L v,A x/*0*/)_(i4(xw,xn,v*=xg,v*=xh,v*=xi,v*=xl)v)
S A3(admf,/*010*/I i=xv==3;U n=zn;P((y&&ytf)||ztF,F v=y?gf(cF(y)):i;z=cF(zR);Mz(I(i,i(n,v*=zf))E(i(n,v+=zf)))af(v))L v=y?gl(y):i;az((i?mulfZ:addfZ)(v,z)))
...
S A3(eqls,/*010*/U n=zn,i=!y;L v=gl(y?y:io(z,0)),a=v;A u=aG(n);S4(zw,W(i<n,ug=v=v==zg;i++),W(i<n,ug=v=v==zh;i++),W(i<n,ug=v=v==zi;i++),W(i<n,ug=v=v==zl;i++))y||!n?u:a4(u,ai(0),av,az(a)))
...
S A3(mxmp,/*010*/U w=zw;L v=gl(y),l=-1ll<<(8<<w)-1,h=~l;MAXE(v,l);N n=zn;P(v>=h,rsz(n,az(v)))y=an(zn,tG+zw);S4(w,zG[-1]=v,zH[-1]=v,zI[-1]=v,zL[-1]=v)N j=n-1;
...
S A3(cmpp,/*010*/I o=x-LTN,w=zw;U n=zn;A u=aG(n);L v=gl(y),p=iw(z,w,0);*uG=!o?p<v:o==1?p>v:p==v;L m=n-1,j=m;
...
S I ina(A x/*0*/,U n)_(S4(xw,P(n-(G)n,1)i(xn,P(!IN(xg,n),0)),P(n-(H)n,1)i(xn,P(!IN(xh,n),0)),P(n-(I)n,1)i(xn,P(!IN(xi,n),0)),i(xn,P(!IN(xl,n),0)))1)
