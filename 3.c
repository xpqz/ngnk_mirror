...
S L minfG(O V*a,U n)_(O G*p=a;G r=(1u  << 7)-1;i(n,MINE(r,p[i]))r)
S L minfH(O V*a,U n)_(O H*p=a;H r=(1u  <<15)-1;i(n,MINE(r,p[i]))r)
S L minfI(O V*a,U n)_(O I*p=a;I r=(1u  <<31)-1;i(n,MINE(r,p[i]))r)
S L minfL(O V*a,U n)_(O L*p=a;L r=(1ull<<63)-1;i(n,MINE(r,p[i]))r)
S L maxfG(O V*a,U n)_(O G*p=a;G r=(1u  << 7)  ;i(n,MAXE(r,p[i]))r)
S L maxfH(O V*a,U n)_(O H*p=a;H r=(1u  <<15)  ;i(n,MAXE(r,p[i]))r)
S L maxfI(O V*a,U n)_(O I*p=a;I r=(1u  <<31)  ;i(n,MAXE(r,p[i]))r)
S L maxfL(O V*a,U n)_(O L*p=a;L r=(1ull<<63)  ;i(n,MAXE(r,p[i]))r)
