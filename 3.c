...
Z A3(dexf,/*010*/A u=las(zR);I(y,y(0))u)
  L addfB(CO V*a,U n)_(CO W*p=a;U r=0;i(n>>6,r+=PC(*p++))n&=63;n?r+PC(*p&~(-1ll<<n)):r)
Z L addfG(CO V*a,U n)_(CO G*p=a;L r=0;i(n,r+=*p++)r)
Z L addfH(CO V*a,U n)_(CO H*p=a;L r=0;i(n,r+=*p++)r)
Z L addfI(CO V*a,U n)_(CO I*p=a;L r=0;i(n,r+=*p++)r)
Z L addfL(CO V*a,U n)_(CO L*p=a;L r=0;i(n,r+=*p++)r)
Z L mulfG(CO V*a,U n)_(CO G*p=a;L r=1;i(n,r*=*p++)r)
Z L mulfH(CO V*a,U n)_(CO H*p=a;L r=1;i(n,r*=*p++)r)
Z L mulfI(CO V*a,U n)_(CO I*p=a;L r=1;i(n,r*=*p++)r)
Z L mulfL(CO V*a,U n)_(CO L*p=a;L r=1;i(n,r*=*p++)r)
Z L minfB(CO V*a,U n)_(CO W*p=a;i(n>>6,P(~*p++,0))n&=63;n?!!~(*p|(-1ll<<n)):1)
Z L minfG(CO V*a,U n)_(CO G*p=a;G r=(1u  << 7)-1;i(n,r=MIN(r,p[i]))r)
Z L minfH(CO V*a,U n)_(CO H*p=a;H r=(1u  <<15)-1;i(n,r=MIN(r,p[i]))r)
Z L minfI(CO V*a,U n)_(CO I*p=a;I r=(1u  <<31)-1;i(n,r=MIN(r,p[i]))r)
Z L minfL(CO V*a,U n)_(CO L*p=a;L r=(1ull<<63)-1;i(n,r=MIN(r,p[i]))r)
Z L maxfB(CO V*a,U n)_(CO W*p=a;i(n>>6,P( *p++,1))n&=63;n?!!(*p&~(-1ll<<n)):0)
Z L maxfG(CO V*a,U n)_(CO G*p=a;G r=(1u  << 7)  ;i(n,r=MAX(r,p[i]))r)
Z L maxfH(CO V*a,U n)_(CO H*p=a;H r=(1u  <<15)  ;i(n,r=MAX(r,p[i]))r)
Z L maxfI(CO V*a,U n)_(CO I*p=a;I r=(1u  <<31)  ;i(n,r=MAX(r,p[i]))r)
Z L maxfL(CO V*a,U n)_(CO L*p=a;L r=(1ull<<63)  ;i(n,r=MAX(r,p[i]))r)
...
Z A3(admf,/*010*/B i=xv==3;U n=zn;P((y&&ytf)||ztF,F v=y?gf(cF(y)):i;z=cF(zR);Mz(I(i,i(n,v*=zf))E(i(n,v+=zf)))af(v))L v=y?gl(y):i;az((i?mulfZ:addfZ)(v,z)))
...
Z A3(mxms,/*010*/P((!y||ytz)&&ztZ,L v=y?gl(y):-WL,l=-1ll<<(1<<zw)-1,h=~l;U n=zn;I(v<=l||h<=v,P(v>=0,rsz(n,az(v)))v=v<0?l:h)
...
Z A eqlsL(L v,A x/*0*/)_(A y=aG(xn);i4(xw-3,xn,yg=v=v==xg,yg=v=v==xh,yg=v=v==xi,yg=v=v==xl)y)
...
Z B ina(A x/*0*/,U n)_(S4(xw-3,P(n-(G)n,1)i(xn,P(xg>=n,0)),P(n-(H)n,1)i(xn,P(xh>=n,0)),P(n-(I)n,1)i(xn,P(xi>=n,0)),i(xn,P(xl>=n,0)))1)
