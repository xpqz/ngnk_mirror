...
S A3(___f,/*010*/N i=!y;I(i,y=io(z,0))N n=zn;W(i<n,y=y(x2(y,ii(z,i++)));B(!y))y)
S A3(dexf,/*010*/A u=las(zR);y?y(u):u)
L minfZ(L v,A x/*0*/)_(i4(xw,xn,MINE(v,xg),MINE(v,xh),MINE(v,xi),MINE(v,xl))v)
L maxfZ(L v,A x/*0*/)_(i4(xw,xn,MAXE(v,xg),MAXE(v,xh),MAXE(v,xi),MAXE(v,xl))v)
S A3(mmmf,/*010*/I i=xv==7;P((y&&ytf)||ztF,y=of1(y?cF(y):aV(tf,1,A((L)i<<63|WFL)));z=of1(cF(zR));of0(N(z(mmmf(x,y,z)))))L v=y?gl(y):i?-WL:WL;
 L l=-1ll<<8*zW-1,h=~l;N n=zn;P((i?v>=h:v<=l)||!n,az(v))v=v<l?l:v>h?h:v;az(i?maxfZ(v,z):minfZ(v,z)))
L addfZ(L v,A x/*0*/)_(i4(xw,xn,v+=xg,v+=xh,v+=xi,v+=xl)v)
L mulfZ(L v,A x/*0*/)_(i4(xw,xn,v*=xg,v*=xh,v*=xi,v*=xl)v)
S A3(admf,/*010*/I i=xv==3;N n=zn;P((y&&ytf)||ztF,F v=y?gf(cF(y)):i;z=cF(zR);Mz(I(i,i(n,v*=zf))E(i(n,v+=zf)))af(v))L v=y?gl(y):i;az((i?mulfZ:addfZ)(v,z)))
S A3(subf,/*010*/y=y?neg(y):zn?mul(ai(-2),ii(z,0)):ai(0);neg(admf(ADD,y,z)))
A3(arf,/*010*/Q(xtv)Q(xv<11)Q(!y||ytzfc)Q(ztZFC)ZE(P(ztE&&x==ADD&&!y,L i=*zL,j=zL[1];az((j-i)*(j+i-1)/2))z=gZ(zR);z(arf(x,y,z)))
 A(&dexf,admf,subf,admf,___f,___f,mmmf,mmmf,___f,___f,___f)[xv](x,y,z))

S A3(___s,/*010*/N i=!y;A u;I(i,y=ii(z,0);u=enl(yR))E(yR;u=oG)N n=zn;W(i<n,y=y(x2(y,ii(z,i++)));P(!y,u(0))uq(yR))y(u))
S A3(dexs,/*010*/y?y(zR):zR)
S A3(adms,/*010*/L w=y?gl(y):x==MUL;N n=zn;I b=1;L v=w;C t=tG+zw;A u=an(n,t);
...
S A3(mxms,/*010*/P((!y||ytz)&&ztZ,L v=y?gl(y):-WL,l=-1ll<<8*zW-1,h=~l;N n=zn;I(v<=l||h<=v,P(v>=0,rsz(n,az(v)))v=v<0?l:h)
...
S A eqlsL(L v,A x/*0*/)_(A y=aG(xn);i4(xw,xn,yg=v=v==xg,yg=v=v==xh,yg=v=v==xi,yg=v=v==xl)y)
S A3(eqls,/*010*/N n=zn,i=!y;L v=gl(y?y:io(z,0)),a=v;A u=aG(n);S4(zw,W(i<n,ug=v=v==zg;i++),W(i<n,ug=v=v==zh;i++),W(i<n,ug=v=v==zi;i++),W(i<n,ug=v=v==zl;i++))y||!n?u:a4(u,ai(0),av,az(a)))
...
S A3(mxmp,/*010*/I w=zw;L v=gl(y),l=-1ll<<(8<<w)-1,h=~l;MAXE(v,l);N n=zn;P(v>=h,rsz(n,az(v)))y=an(zn,tG+zw);S4(w,zG[-1]=v,zH[-1]=v,zI[-1]=v,zL[-1]=v)N j=n-1;
...
S A3(cmpp,/*010*/I o=x-LTN,w=zw;N n=zn;A u=aG(n);L v=gl(y),p=iw(z,w,0);*uG=!o?p<v:o==1?p>v:p==v;L m=n-1,j=m;
...
S A4(dexa,/*1000*/uR;Ny(sup(&x,&u));x=mut(x);N n=yn;I wx=xw,wy=yw,wu=utt?-1:uw;L v=wu<0?gl_(u):0;
...
S A4(adma,/*1000*/yR;uR;x=cL(x);u=cL(u);x=mut(x);I(!ytL,y=cI(y))N n=yn;
...
S A4(mmma,/*1000*/yR;uR;B d=utT;I(!d,u=enl(u))Ny(sup(&x,&u));x=mut(x);I(!ytL,y=cI(y))N n=yn;
...
S I ina(A x/*0*/,N n)_(S4(xw,P(n-(G)n,1)i(xn,P(!IN(xg,n),0)),P(n-(H)n,1)i(xn,P(!IN(xh,n),0)),P(n-(I)n,1)i(xn,P(!IN(xi,n),0)),i(xn,P(!IN(xl,n),0)))1)
