...
S L maxfL(O V*a,U n)_(O L*p=a;L r=(1ull<<63)  ;i(n,r=MAX(r,p[i]))r)
  L addfZ(L v,A x/*0*/)_(v+    G(&addfG,addfH,addfI,addfL)[xw](xV,xn) )
S L mulfZ(L v,A x/*0*/)_(v*    G(&mulfG,mulfH,mulfI,mulfL)[xw](xV,xn) )
  L minfZ(L v,A x/*0*/)_(MIN(v,G(&minfG,minfH,minfI,minfL)[xw](xV,xn)))
S L maxfZ(L v,A x/*0*/)_(MAX(v,G(&maxfG,maxfH,maxfI,maxfL)[xw](xV,xn)))
