...
#define i4(w,n,a,b,c,d) S4(w,F(n,a),F(n,b),F(n,c),F(n,d))
...
Z B ina(A x/*0*/,U n)_(S4(xw-3,P(n-(G)n,1)F(xn,P(xg>=n,0)),P(n-(H)n,1)F(xn,P(xh>=n,0)),P(n-(I)n,1)F(xn,P(xi>=n,0)),F(xn,P(xl>=n,0)))1)
