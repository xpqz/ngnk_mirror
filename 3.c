...
S A3(adms,/*010*/L w=y?gl(y):x==MUL;Nn=zn;I b=1;Lv=w;Ct=tG+zw;Au=an(n,t);
...
S A eqlsL(Lv,Ax/*0*/)_(Ay=aG(xn);i4(xw,xn,yg=v=v==xg,yg=v=v==xh,yg=v=v==xi,yg=v=v==xl)y)
S A3(eqls,/*010*/Nn=zn,i=!y;Lv=gl(y?y:io(z,0)),a=v;Au=aG(n);S4(zw,W(i<n,ug=v=v==zg;i++),W(i<n,ug=v=v==zh;i++),W(i<n,ug=v=v==zi;i++),W(i<n,ug=v=v==zl;i++))y||!n?u:a4(u,ai(0),av,az(a)))
...
S A3(mxmp,/*010*/I w=zw;Lv=gl(y),l=-1ll<<(8<<w)-1,h=~l;MAXE(v,l);Nn=zn;P(v>=h,rsz(n,az(v)))y=an(zn,tG+zw);S4(w,zG[-1]=v,zH[-1]=v,zI[-1]=v,zL[-1]=v)Nj=n-1;
...
S A3(cmpp,/*010*/I o=x-LTN,w=zw;Nn=zn;Au=aG(n);Lv=gl(y),p=iw(z,w,0);*uG=!o?p<v:o==1?p>v:p==v;Lm=n-1,j=m;
