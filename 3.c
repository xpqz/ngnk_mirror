...
S L addfG(CO V*a,U n)_(CO G*p=a;L r=0;i(n,r+=*p++)r)
S L addfH(CO V*a,U n)_(CO H*p=a;L r=0;i(n,r+=*p++)r)
S L addfI(CO V*a,U n)_(CO I*p=a;L r=0;i(n,r+=*p++)r)
S L addfL(CO V*a,U n)_(CO L*p=a;L r=0;i(n,r+=*p++)r)
S L mulfG(CO V*a,U n)_(CO G*p=a;L r=1;i(n,r*=*p++)r)
S L mulfH(CO V*a,U n)_(CO H*p=a;L r=1;i(n,r*=*p++)r)
S L mulfI(CO V*a,U n)_(CO I*p=a;L r=1;i(n,r*=*p++)r)
S L mulfL(CO V*a,U n)_(CO L*p=a;L r=1;i(n,r*=*p++)r)
S L minfB(CO V*a,U n)_(CO W*p=a;i(n>>6,P(~*p++,0))n&=63;n?!!~(*p|(-1ll<<n)):1)
S L minfG(CO V*a,U n)_(CO G*p=a;G r=(1u  << 7)-1;i(n,r=MIN(r,p[i]))r)
S L minfH(CO V*a,U n)_(CO H*p=a;H r=(1u  <<15)-1;i(n,r=MIN(r,p[i]))r)
S L minfI(CO V*a,U n)_(CO I*p=a;I r=(1u  <<31)-1;i(n,r=MIN(r,p[i]))r)
S L minfL(CO V*a,U n)_(CO L*p=a;L r=(1ull<<63)-1;i(n,r=MIN(r,p[i]))r)
S L maxfB(CO V*a,U n)_(CO W*p=a;i(n>>6,P( *p++,1))n&=63;n?!!(*p&~(-1ll<<n)):0)
S L maxfG(CO V*a,U n)_(CO G*p=a;G r=(1u  << 7)  ;i(n,r=MAX(r,p[i]))r)
S L maxfH(CO V*a,U n)_(CO H*p=a;H r=(1u  <<15)  ;i(n,r=MAX(r,p[i]))r)
S L maxfI(CO V*a,U n)_(CO I*p=a;I r=(1u  <<31)  ;i(n,r=MAX(r,p[i]))r)
S L maxfL(CO V*a,U n)_(CO L*p=a;L r=(1ull<<63)  ;i(n,r=MAX(r,p[i]))r)
