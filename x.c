...
S A2(f,/*01*/y=apc(y,xt);XmMA(fA(x,y))XS(y=ff(xn,y);i(xn,y=f(as(xi),y))y)Xs(Lv=xv;Qs=qs(&v);In=SL(s)+1;y=apc(y,n);cts(y,s,n))XP(ff(x,y))XU(Q(xw==4);fA(x,apc(y,(xtr?xE:xv)<<3|xk)))
