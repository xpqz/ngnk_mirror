...
SN V cGH(OV*RES a,V*RES b,U n)_(O G*p=a;H*r=b;i(n+15&-16,r[i]=p[i]))
SN V cGI(OV*RES a,V*RES b,U n)_(O G*p=a;I*r=b;i(n+ 7& -8,r[i]=p[i]))
SN V cHG(OV*RES a,V*RES b,U n)_(O H*p=a;G*r=b;i(n+31&-32,r[i]=p[i]))
SN V cHI(OV*RES a,V*RES b,U n)_(O H*p=a;I*r=b;i(n+ 7& -8,r[i]=p[i]))
SN V cHL(OV*RES a,V*RES b,U n)_(O H*p=a;L*r=b;i(n+ 3& -4,r[i]=p[i]))
SN V cIG(OV*RES a,V*RES b,U n)_(O I*p=a;G*r=b;i(n+ 7& -8,r[i]=p[i]))
SN V cIH(OV*RES a,V*RES b,U n)_(O I*p=a;H*r=b;i(n+ 7& -8,r[i]=p[i]))
SN V cIL(OV*RES a,V*RES b,U n)_(O I*p=a;L*r=b;i(n+ 3& -4,r[i]=p[i]))
SN V cLG(OV*RES a,V*RES b,U n)_(O L*p=a;G*r=b;i(n+ 3& -4,r[i]=p[i]))
SN V cLH(OV*RES a,V*RES b,U n)_(O L*p=a;H*r=b;i(n+ 3& -4,r[i]=p[i]))
SN V cLI(OV*RES a,V*RES b,U n)_(O L*p=a;I*r=b;i(n+ 3& -4,r[i]=p[i]))
SN V cLF(OV*RES a,V*RES b,U n)_(O L*p=a;F*r=b;i(n+ 3& -4,r[i]=p[i]==NL  ?NF:p[i]))
SN V cFL(OV*RES a,V*RES b,U n)_(O F*p=a;L*r=b;i(n+ 3& -4,r[i]=p[i]!=p[i]?NL:p[i]))
