...
K n_k TD S SN NI O ST EX BR CO SW CA __attribute__ asm enum do struct union for if else extern
   \ switch case default break continue return goto                                |H n_k statement
...
R n_pp g=n_p s="\v<(P|[XYZ]\w{,4}|CR)\("     e=")" c=@n_x,n_p |M n_p "," contained |H n_p function
