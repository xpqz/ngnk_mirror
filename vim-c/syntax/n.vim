...
K n_k TD Z ZN NI CO ST EX __attribute__ asm enum do struct union for
...
R n_ff g=n_f s="\<\([WF]\|Fj\|F4\)("               e=")" c=@n_x,n_f |M n_f "," contained |H n_f special
R n_ii g=n_i s="\<\([IJEBUCDXY]\|C\d\+\|S\d\=\)("  e=")" c=@n_x,n_i |M n_i "," contained |H n_i type
