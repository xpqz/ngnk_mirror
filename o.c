...
X1(grp,Rz(K1("=/:/2#,!:",x))Rm(Ay=kv(&x);y=Nx(grp(y));yy=x(i1(x,yy));y)R_(et1(x))
 ...
 RGC(I*r[  256];UC b[  256];UI c[  256]={},k=0,n=xn;i(n,UC v=xg;I(!c[v]++,b[k++]=v))Az=aA(k);i(k|!k,r[b[i]]=_I(za=aI(c[b[i]])))Mx(i(n,*r[(UC)xg]++=i))am(aV(xt,k,b),z))
 RH( I*r[65536];UH b[65536];UI c[65536]={},k=0,n=xn;i(n,UH v=xh;I(!c[v]++,b[k++]=v))Az=aA(k);i(k|!k,r[b[i]]=_I(za=aI(c[b[i]])))Mx(i(n,*r[(UH)xh]++=i))am(aV(xt,k,b),z)))
