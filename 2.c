...
Z A cmpZZ(A x,A y,U f)_(U w=xw-3;P(w<yw-3,x=ct(tG+yw-3,xR);x(cmpZZ(x,y,f)))I(yw-3<w,y=ct(tG+w,y))V*a=xV,*b=yV;I(f==9,SWP(a,b))
...
Z A addfF(F v,A y,U f)_(A z=yr-1?aF(yn):y;U n=zn+3&-4;i(n,zf=v+yf)y-z?y(z):z)
Z A mulfF(F v,A y,U f)_(A z=yr-1?aF(yn):y;U n=zn+3&-4;i(n,zf=v*yf)y-z?y(z):z)
Z A admfF(F v,A y,U f)_((f==3?mulfF:addfF)(v,y,f))
Z A dvdfF(F v,A y,U f)_(A z=yr-1?aF(yn):y;U n=zn+3&-4;i(n,zf=v/yf)y-z?y(z):z)
Z A dvdFf(A x,F v,U f)_(A z=aF(xn);i(xn,zf=xf/v)z)
